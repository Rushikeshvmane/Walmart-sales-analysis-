...
/*-------------------------------------------------------------------------
-- ---------------------------- Generic Questions & their answers ----------
-- ---------------------------------------------------------------------- */
...
/* -- --------------------------------------------------------------------
-- ---------------------------- Product Questions & their answers---------
-- --------------------------------------------------------------------*/
...
ORDER BY total_tax desc;
  ...
  /*-- -----------------------------------------------------------------
-- --------------------Customers Questions & their answers --------------
-- --------------------------------------------------------------------*/   
...
# Gender per branch is more or less the same hence, I don't think it has an effect on the sales per branch and other factors.
...
GROUP BY day_name 
ORDER BY avg_rating DESC;
# Mon, Tue and Friday are the top best days with good ratings.
